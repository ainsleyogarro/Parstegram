...
import com.example.parstegram.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    // The onCreateView method is called when Fragmebt should create its View object hierarchy
    @Override
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (description.isEmpty()){
                    Toast.makeText(getContext(), "Desciription cannot be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
